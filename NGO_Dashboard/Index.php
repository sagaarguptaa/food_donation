...
if(isset($_REQUEST['passupdate'])){
  ...
  if($Pass == "" || $cPass == ""){
   ...
   $sql = "UPDATE ngo_signup SET ngo_pass = '$Pass' , ngo_repass='$Pass' WHERE ngo_email = '$ngoemail'";
...
<a name="notification-page"></a>
    <div class="main-content">
      ...
      <div class="dashboard-page">
        ...
        <div class="res-table">
          <p id="heading-top">Total Messages from Restuarant</p>
          <div class="table-res">
            <table>
            <tr id="res-table-menu">
                <th>id</th>
...
if($num> 0){    
    while($row = mysqli_fetch_assoc($result)){         
       ...
       <tr>               
                ...
                <td><img src="<?php echo $row['res_image']; ?>" width="100px" height="100px"></td>
