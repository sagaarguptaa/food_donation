    ...
    <header>
      <div class="image-text">
        ...
        <div class="text logo-text">
          <span class="name">FoodDonation</span>
...
$sql = "SELECT * FROM admin_login WHERE admin_email ='".$aemail."'";
...
if($num> 0){
    ...
    while($row = mysqli_fetch_assoc($result)){
      ...
      ?>
           ...
           <p><strong>Name: </strong><?php echo $row['admin_name'];?></p>
           <p><strong>Mobile No.: </strong><?php echo $row['admin_mobile'];?></p>
           <p><strong>Email: </strong><?php echo $row['admin_email'];?></p>
...
<a name="notification-page-1"></a>
    <div class="main-content">
      ...
      <div class="dashboard-page">
        ...
        <div class="res-table">
          <p id="heading-top">Total Messages form Restaurant</p>
          <div class="table-res">
            <table>
            <tr id="res-table-menu">
                <th>id</th>
 ...
 <a name="notification-page-2"></a>
    <div class="main-content">
      ...
      <div class="dashboard-page">
        ...
        <div class="res-table">
          <p id="heading-top">Total Messages from NGO</p>
          <div class="table-res">
            <table>
            <tr id="res-table-menu">
                <th>id</th>
...
?>
 ...
 error_reporting(0);
     ...
     while ($row = mysqli_fetch_array($result)){
      echo '<tr>';
       ...
       echo '<td>';
        ...
        echo '<input type="hidden" name="id" value='.$row['id'].'><button class="btn btn-secondary "  name="delete" value="Delete" type="submit"><i class="far fa-trash-alt" ></i></button>';
       echo '</form>';
       echo '</td>';
      echo '</tr>';
     }
  ...
  if(isset($_REQUEST['delete'])){
   $sql= "DELETE FROM res_signup WHERE id = {$_REQUEST['id']}";
 ...
 <?php
  ...
  if(isset($_REQUEST['delete'])){
   $sql= "DELETE FROM ngo_signup WHERE id = {$_REQUEST['id']}";
   if($conn->query($sql) == TRUE){
    header("Location: Index.php");
   } else {
    echo "Unable to Delete Data";
 ...
 ?>
    ...
    <footer class="main-footer">
      ...
      <strong class="no-print">Developed and Maintained by <a href="https://www.instagram.com/sagaar.guptaa/?next=%2F">Geeta</a>.</strong>
    </footer>
    <!-- FOOTER END -->
  </section>
  <!-- SECTION END -->
