...
<div class="box-form">
	<div class="left">
		...
		<div class="right">
		<p>You have already an account! <a href="NGO-login.php">Login</a>. <a href="index.php" style="color:red;">Close</a></p>
        ...
        <div class="inputs">
            ...
            <br>
            <button type="submit" class="btn" name="nsignup" value="Submit">Register</button>
		</div>
