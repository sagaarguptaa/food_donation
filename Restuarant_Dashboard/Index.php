...
if(isset($_REQUEST['passupdate'])){
  ...
  if($Pass == "" || $cPass == ""){
   ...
   $sql = "UPDATE res_signup SET res_pass = '$Pass' , res_repass='$Pass' WHERE res_email = '$resemail'";
...
if($_SESSION['remail'] ==""){
    header("location:resturant-login.php");
}
$error="";
if(isset($_POST['submitrequest'])){
  ...
  $date = $_POST['date'];
	...
	if(in_array($filecheck,$fileextstore)){
		$destination = '../NGO_Dashboard/images/'.$filename;
...
if(($info == "") || ($name == "") || ($email == "") || ($mobile == "") || ($msg == "") || ($date == "")){
  ...
  $sql = "INSERT INTO res_message (res_info, res_name, res_email, res_mobile, res_msg, res_date, res_image)VALUES('$info', '$name', '$email', '$mobile', '$msg', '$date', '$destination')";
 ...
 <?php if(isset($msg)) {echo $msg;} ?>
  ...
  box-sizing: border-box;" id="inputEmail" name="email">
   ...
   <div class="form-group ">
    ...
    <input type="text" max-length="10" class="form-control" style=" width: 100%;
  padding: 5px 10px;
  margin: 8px 0;
  display: inline-block;
  border: 1px solid #ccc;
  ...
  <input type="file" class="custom-file-input" name="fileupload" id="customFile" required>
  </div>
 ...
 <a name="notification-page"></a>
    ...
    <div class="main-content">
      ...
      <div class="dashboard-page">
        ...
        <div class="res-table">
          <p id="heading-top">Total Messages from NGOs</p>
          <div class="table-res">
            <table>
            <tr id="res-table-menu">
                <th>id</th>
